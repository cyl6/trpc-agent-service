...
完整修复说明、测试和生产验收边界见 [Review 修复记录](docs/review-2026-09-11.md)。这不改变下文列出的多媒体、DLP、在线迁移等能力边界。
...
ACME_WECOM_AIBOT_ID=your-wecom-ai-bot-id
ACME_WECOM_AIBOT_SECRET=your-wecom-ai-bot-secret
```
...
```bash
export DASHSCOPE_API_KEY='sk-...'   # 仅环境变量注入
...
```text
ACME_WECOM_AIBOT_ID=your-bot-id
ACME_WECOM_AIBOT_SECRET=your-bot-secret
```
